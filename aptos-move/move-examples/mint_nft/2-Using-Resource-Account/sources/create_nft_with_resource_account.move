...
module mint_nft::create_nft_with_resource_account {
    ...
    fun init_module(resource_signer: &signer) {
        ...
        let token_data_id = token::create_tokendata(
            ...
            vector<String>[string::utf8(b"given_to"),string::utf8(b"data1")],
            vector<vector<u8>>[b"asdf", b"asdf"],
            vector<String>[ string::utf8(b"address"),string::utf8(b"string") ],
        );
    ...
    public entry fun update_metadata(admin: &signer) acquires ModuleData {
        
    }

    // public entry fun redeem_nft(owner: &signer, receiver: &signer) acquires ModuleData {
    //     let receiver_addr = signer::address_of(receiver);
    //     token::direct_transfer(&resource_signer, receiver, token_id, 1);
    // }
}
